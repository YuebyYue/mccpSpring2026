...
During the preparation of this manuscript, the author used GitHub Copilot (Microsoft) to assist in analyzing reviewer comments and generating initial suggestions for manuscript revisions. These AI-generated suggestions were subsequently reviewed, evaluated, and substantially modified by the author. The AI tool was also used to help apply language and structural edits to the draft during the revision process. All outputs generated by the AI tool were carefully checked and edited, and the author takes full responsibility for the accuracy, integrity, and final content of the manuscript.
